...
{
    /// <inheritdoc />
    public class SaveFeaturedTopicsSettingsModelValidator : AbstractValidator<SaveFeaturedCarouselSettingsModel>
    {
        /// <inheritdoc />
        public SaveFeaturedTopicsSettingsModelValidator()
        {
